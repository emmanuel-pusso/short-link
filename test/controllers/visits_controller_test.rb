...
class VisitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visit" do
    assert_difference("Visit.count") do
      post visits_url, params: { visit: { date_visit: @visit.date_visit, ip_address: @visit.ip_address } }
    end
  ...
  test "should update visit" do
    patch visit_url(@visit), params: { visit: { date_visit: @visit.date_visit, ip_address: @visit.ip_address } }
